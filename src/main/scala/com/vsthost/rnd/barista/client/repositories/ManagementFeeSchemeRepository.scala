...
import com.vsthost.rnd.barista.client.repositories.models.entities.ManagementFeeScheme
...
/**
  ...
  */
class ManagementFeeSchemeRepository[F[_]](api: BaristaClient[F])
  extends Repository[F, Int, ManagementFeeScheme](api, "mfpercentages")
