...
import com.vsthost.rnd.barista.client.repositories.models.entities.Artifact
...
/**
  ...
  */
class ArtifactRepository[F[_]](api: BaristaClient[F]) extends Repository[F, Int, Artifact](api, "resources")
