...
import com.vsthost.rnd.barista.client.repositories.models.entities.Action
...
/**
  ...
  */
class ActionRepository[F[_]](api: BaristaClient[F]) extends Repository[F, Int, Action](api, "trades")
