...
import com.vsthost.rnd.barista.client.repositories.models.entities.Institution
...
/**
  * Provides a remote API repository for [[Institution]]s.
  *
  * @param api The API algebra to be used to work on records.
  * @tparam F Context type parameter.
  */
class InstitutionRepository[F[_]](api: BaristaClient[F]) extends Repository[F, Int, Institution](api, "institutions")
